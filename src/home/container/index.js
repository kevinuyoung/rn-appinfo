...
import { View, Button, TextInput, Text, StatusBar, SafeAreaView, StyleSheet, Image, Dimensions, ScrollView, TouchableHighlight } from 'react-native';
        ...
        <SafeAreaView>
          <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableHighlight onPress={() => { this.props.navigation.push('SearchAll')}} underlayColor="#fff">
                  <View style={styles.input}>
                    <Text style={{color:'#5a5656'}}>Type here to search!</Text>
                  </View>
                </TouchableHighlight>
